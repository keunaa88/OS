...
namespace OS_FinalProject
{
    public class Vehicle
    {
        ...
        public Vehicle(int pid, string pManufacturer, string pModel, string pRegistrationNo, int pYearOfManufacture, Journey pJourney, FuelPurchase pFuelPurchase, PerDayRental pPerDayRental, PerKmRental pPerKmRental, Service pService)
        {
            Id = pid;
